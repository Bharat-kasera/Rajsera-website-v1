...
import { IoMdArrowForward, IoMdGlobe, IoMdCart, IoMdBusiness, IoMdPeople, IoMdDocument, IoMdCloud, IoMdBriefcase, IoMdSchool, IoMdTrendingUp, IoMdMedkit, IoMdHome, IoMdBuild, IoMdCode, IoLogoApple, IoLogoAndroid, IoMdPhonePortrait, IoMdWatch, IoMdApps, IoMdFlash, IoMdWifi, IoMdLink, IoMdEye, IoMdCamera, IoMdCreate, IoMdPerson, IoMdRefresh, IoMdChatbubbles, IoMdConstruct, IoMdSettings, IoMdCheckmarkCircle, IoMdText, IoMdMic, IoMdVolumeHigh, IoMdImage, IoMdAnalytics, IoMdLock, IoMdPaper, IoMdStats, IoMdRocket, IoMdInfinite, IoMdHeadset, IoMdBulb, IoMdCube, IoMdSearch, IoMdMap, IoMdColorPalette, IoMdCheckmarkCircleOutline, IoMdDesktop, IoMdLaptop, IoMdGrid, IoMdHand, IoLogoGameControllerB, IoMdBrush } from "react-icons/io";
import { FaReact, FaShieldAlt } from "react-icons/fa";
import gsap from "gsap";

// Icon mapping object
const iconMap = {
  IoMdGlobe, IoMdCart, IoMdBusiness, IoMdPeople, IoMdDocument, IoMdCloud, IoMdBriefcase, IoMdSchool, IoMdTrendingUp, IoMdMedkit, IoMdHome, IoMdBuild, IoMdCode, IoLogoApple, IoLogoAndroid, IoMdPhonePortrait, IoMdWatch, IoLogoReact: FaReact, IoMdApps, IoMdFlash, IoMdWifi, IoMdLink, IoMdEye, IoMdCamera, IoMdCreate, IoMdPerson, IoMdRefresh, IoMdChatbubbles, IoMdConstruct, IoMdSettings, IoMdCheckmarkCircle, IoMdText, IoMdMic, IoMdVolumeHigh, IoMdImage, IoMdAnalytics, IoMdLock, IoMdShield: FaShieldAlt, IoMdPaper, IoMdStats, IoMdRocket, IoMdInfinite, IoMdHeadset, IoMdBulb, IoMdCube, IoMdSearch, IoMdMap, IoMdColorPalette, IoMdCheckmarkCircleOutline, IoMdDesktop, IoMdLaptop, IoMdGrid, IoMdHand, IoLogoGameControllerB, IoMdBrush
};
